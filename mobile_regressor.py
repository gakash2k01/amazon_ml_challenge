...
from transformers import MobileBertPreTrainedModel, MobileBertModel, AutoConfig, AutoTokenizer
from transformers import MobileBertTokenizer, MobileBertConfig
...
class BertRegresser(MobileBertPreTrainedModel):
...
if __name__ == "__main__":
    ...
    # model = MobileBertPreTrainedModel.from_pretrained('google/mobilebert-uncased')
